...
def run_training(data_type="Aside0",
                 model_dir="models",
                 epochs=256,
                 pretrained=True,
                 test_epochs=10,
    ...
    train_data = MVTecAT("/media/sagan/3ACA231948FF6FA0/pre_arranged_database_viva_forcflow/", data_type, transform = train_transform, size=int(size * (1/min_scale)))
