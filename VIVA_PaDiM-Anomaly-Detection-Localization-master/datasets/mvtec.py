...
CLASS_NAMES = ['Aside0', 'Aside1',
               'Cside0', 'Cside1', 'Dside0', 'Dside1']


class MVTecDataset(Dataset):
    def __init__(self, dataset_path='/media/sagan/3ACA231948FF6FA0/pre_arranged_database_viva/', class_name='Aside0', is_train=True,
